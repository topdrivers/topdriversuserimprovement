...
public class ActivitySocialLogin extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mint.initAndStartSession(this.getApplication(), "911b3b5e");
        ...
        facebook_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isInternet) {
                    ...
                    listPermission.add("public_profile");
                    listPermission.add("user_friends");

                    LoginManager.getInstance().logInWithReadPermissions(ActivitySocialLogin.this, listPermission);
